...
def main():
    ...
    st.text("Build with Streamlit, OpenCV & \u2764\uFE0F by Blessed Majome, Anold Kupara, Admire Muzondo")
    ...
    if choice == 'Detection':
        ...
        st.markdown(
            "Built with Streamlit by [Blessed Majome, Anold Kupara and Admire Muzondo](https://www.jometechs.com/)")
        st.success("Blessed Majome")
